...
nodelist <- data.frame(edge_list$course,edge_list$x,
                       edge_list$y) %>% 
  unique()
net<- graph_from_data_frame(vertices = nodelist, d=edge_list)


plot(net,vertex.shape = "none", edge.arrow.size=.4,layout = l)
